...
{
    double cost_phi = 0;
    // int near_way_index_phi = current_way_phi;
    // near_way_index_phi = search_path_index(pose);
    // cost_phi = std::sqrt(std::pow(pose.position.x - goal_path.poses[near_way_index_phi].pose.position.x , 2) + 
